...
public class AskAnalystActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Ask The Analyst");
        ...
        htmlWebView.loadUrl("http://www.equitypandit.com/ask-analyst.php");
